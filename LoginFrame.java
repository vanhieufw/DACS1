...
public class LoginFrame extends JFrame {
    ...
    private void initUI() {
        ...
        setSize(400, 500); // Kích thước bình thường
        ...
        loginButton.addActionListener(e -> {
            ...
            if (authenticate(username, password)) {
                try {
                    SocketClient.sendMessage("Login: " + username);
                } catch (Exception ex) {
                    System.err.println("Lỗi khi gửi thông báo socket: " + ex.getMessage());
                }
        ...
        registerButton = new JButton("Đăng ký người dùng");
        registerButton.setBackground(new Color(0, 120, 215));
        registerButton.setForeground(Color.WHITE);
        registerButton.setFont(new Font("Arial", Font.BOLD, 16));
        registerButton.addActionListener(e -> {
            new RegisterFrame(this).setVisible(true); // Truyền this vào
        });
        gbc.gridy = 5;
    ...
    private boolean authenticate(String username, String password) {
        ...
        return customerBUS.validateUserPlain(username, password); // Dùng plain text password
    }
